...
(function () {
  ...
  if (!state) { console.error("[Liminal Reader] phases.js: no __readerState"); return; }
  ...
  else console.warn("[Liminal Reader] phases.js: #mode-study not found, pill not inserted.");
  ...
  console.log("[Liminal Reader] phases.js ready.");
